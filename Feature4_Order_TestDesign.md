...
| 20 | Cập nhật giỏ hàng | Giỏ hàng có sản phẩm, thay đổi số lượng | Tổng tiền được tính lại chính xác — **Hợp lệ** | V7 |

*Đã ≥8 test case, có cả hợp lệ/không hợp lệ, có test tại biên (TC10, TC11, TC16, TC17), expected result ghi rõ kèm lý do, mỗi TC có tag — đủ yêu cầu Câu 3.*
